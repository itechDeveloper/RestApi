            ...
            StringRequest jsonForPostRequest = new StringRequest(
                    ...
                    response -> {
                        if (response != null) {
                            ...
                            logHelper.logInfo("id: " + AppHelper.getInstance().mData.data.get(0).id);
                            logHelper.logInfo("info: " + AppHelper.getInstance().mData.data.get(0).info);
                            logHelper.logInfo("info: " + AppHelper.getInstance().mData.data.get(0).category);
                        }
